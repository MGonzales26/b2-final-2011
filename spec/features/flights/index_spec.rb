...
RSpec.describe "Flight Index Page" do
  before(:each) do
    ...
    @flight2 = Flight.create(number: 1128, date: "03/05/21", time: "0800", departure_city: "DIA", arrival_city: "DFW")
    @flight2 = Flight.create(number: 1128, date: "03/05/21", time: "1500", departure_city: "DFW", arrival_city: "DIA")
